...
export const SwipeCard: React.FC<SwipeCardProps> = ({
    ...
    return (
        <div className="flex flex-col items-center gap-4">
            ...
            <div className="flex items-center gap-2 px-4 py-2 rounded-full bg-slate-950/80 border border-slate-700/70 backdrop-blur-md">
        <span className="text-[11px] text-slate-400 mr-1">
          Filter by country:
            ...
            {/* ==== KARTU SWIPE TUNGGAL ==== */}
            <div className="relative w-[320px] sm:w-[360px] h-[540px]">
                {!currentNews ? (
            ...
            <p className="text-[11px] text-slate-400/90">
                Drag the card or use the buttons below → right = long, left = short, up
                = skip.
            </p>
        </div>
    );
